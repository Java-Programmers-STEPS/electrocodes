...
$(window).load(function(){  
	...
	try{
		        ...
		        PreparedStatement str3=con.getPreparedstatement("select proid,proname,procategory,proprice,procount,discountprice,prooffr from producttable where promodel=? && procount>=1");
		        str3.setString(1,model);
		        ResultSet rs=str3.executeQuery();
			%>
		<div class="section">
			<!-- container -->
			<div class="container">
	  ...
	  i=1;
	        ...
	        int discountprice=rs.getInt(6);
	        int prooffr=rs.getInt(7);
	        int d=0;
	        if(discountprice<1){
	        	d=1;
		...
		<%} }
		        ...
		        PreparedStatement str3=con.getPreparedstatement("select proid,proname,procategory,proprice,procount,discountprice,prooffr from producttable where proname=? && procount>=1");
		        str3.setString(1,model);
		        ResultSet rs=str3.executeQuery();
			 while(rs.next()){
	  i=1;
		...
		<%} }
					...
					int x=0;
				        ...
				        PreparedStatement str3=con.getPreparedstatement("select count(proid) from producttable where procategory=? && procount>=1");
				        str3.setString(1,model);
				        ResultSet rs=str3.executeQuery();
				        String Countrow="";
				        while(rs.next()){
	...
	int q=0;
			...
			for(int o=0;o<m;o++){
				PreparedStatement str3=con.getPreparedstatement("select proid,proname,procategory,promodel,proprice,procount,discountprice,prooffr from producttable where procategory=? && procount>=1");
				str3.setString(1,model);
		...
		<%}}
					...
					int x=0;
				        ...
				        PreparedStatement str3=con.getPreparedstatement("select count(proid) from producttable where pbrand=? && procount>=1");
				        str3.setString(1,model);
				        ResultSet rs=str3.executeQuery();
				        String Countrow="";
				        while(rs.next()){
	...
	int q=0;
			...
			for(int o=0;o<m;o++){
				PreparedStatement str3=con.getPreparedstatement("select proid,proname,procategory,promodel,proprice,procount,discountprice,prooffr from producttable where pbrand=? && procount>=1");
				str3.setString(1,model);
		...
		<!-- /SECTION -->
									...
									<%if(u!=1){ %><div id="slick-nav-1" class="products-slick-nav"></div>
								</div>
								<!-- /tab -->
							</div>
						</div>
		...
		<%} %>
		<%if(i==0){ %><p style="color:red">0 results found!<%} %>
		<!-- NEWSLETTER -->
		<!-- NEWSLETTER -->
