...
$(window).load(function(){  
	...
	$(window).load(function(){  
		...
		request13.onreadystatechange=cartint; 
		...
		request14.onreadystatechange=wishint;
	...
	<body>
		...
		<%
					...
					int i=0;
				        ...
				        ResultSet rs=st.executeQuery("select count(proid) from producttable where procategory='Accessories' && procount>=1;");
				        String Countrow="";
				        while(rs.next()){
	...
	int q=0;
			...
			for(int o=0;o<m;o++){
				 ResultSet rs=st.executeQuery("select proid,proname,procategory,promodel,proprice,procount,discountprice,prooffr from producttable where procategory='Accessories' && procount>=1;");
			%>
		<div class="section">
			<!-- container -->
			<div class="container">
