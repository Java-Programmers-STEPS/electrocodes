...
$(window).load(function(){  
	...
	if(val.indexOf("up")>-1){
		window.location.href="camera.jsp"
	}
	else{
		alert("Error");}
	}}
	...
	<body>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li  class="active"><a href="camera.jsp">Cameras</a></li>
		...
		<%
					...
					int i=0;
				        ...
				        ResultSet rs=st.executeQuery("select count(proid) from producttable where procategory='Camera' && procount>=1;");
				        String Countrow="";
				        while(rs.next()){
	...
	int q=0;
			...
			for(int o=0;o<m;o++){
				 ResultSet rs=st.executeQuery("select proid,proname,procategory,promodel,proprice,procount,discountprice,prooffr from producttable where procategory='Camera' && procount>=1;");
			%>
		<div class="section">
			<!-- container -->
			<div class="container">
