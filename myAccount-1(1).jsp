...
$(window).load(function(){  
	...
	if(window.XMLHttpRequest){  
		request90=new XMLHttpRequest();  
	}  
	else if(window.ActiveXObject){  
		request90=new ActiveXObject("Microsoft.XMLHTTP");  
	}  
	  
	try{  
		request90.onreadystatechange=getInfo90;  
		request90.open("GET",url,true);  
		request90.send();  
	}catch(e){alert("Unable to connect to server");}  
	}  
	  
	function getInfo90(){  
	if(request90.readyState==4){  
	var val=request90.responseText;
...
<form name="regis" action="passchange.jsp">
