	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		connection con= new connection();
		 if(email!=null){
			...
			PreparedStatement str=con.getPreparedstatement("insert into producttable(proname,proprice,pbrand,procategory,promodel,prodescription,proimage1,proimage2,proimage3,procount) values(?,?,?,?,?,?,?,?,?,?)");
