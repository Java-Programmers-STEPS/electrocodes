...
public class CreateCustomerShippingAddress {
	...
	public static String run(String apiLoginId, String transactionKey, String customerProfileId,String First_Name,String Last_Name,String Address_Line1,String email,String City,String State,String Pincode,String Country,String Phone_Number) {
        ...
        customerAddressType.setAddress(Address_Line1);
        customerAddressType.setCity(City);
        customerAddressType.setState(State);
        customerAddressType.setZip(Pincode);
        customerAddressType.setCountry(Country);
        customerAddressType.setPhoneNumber(Phone_Number);
