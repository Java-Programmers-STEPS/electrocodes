...
$(window).load(function(){  
	...
	if(val.indexOf("up")>-1){
		window.location.href="hotdeals.jsp"
	}
	else{
		alert("Error");}
	}}
	...
	<body>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					<!-- NAV -->
						...
						<li  class="active" ><a href="hotdeals.jsp">Hot Deals</a></li>
		...
		<%
					...
					int i=0;
				        ...
				        ResultSet rs=st.executeQuery("select count(proid) from producttable where prooffr!= 0 && procount>=1");
				        String Countrow="";
				        while(rs.next()){
	...
	int q=0;
			...
			for(int o=0;o<m;o++){
				 ResultSet rs=st.executeQuery("select proid,proname,procategory,promodel,proprice,procount,discountprice,prooffr from producttable where prooffr!= 0 && procount>=1  ORDER BY prooffr DESC");
			%>
		<div class="section">
			<!-- container -->
			<div class="container">
