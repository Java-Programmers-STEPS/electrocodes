...
$(window).load(function(){  
	...
	<body>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li   class="active" ><a href="mobile.jsp">Smartphones</a></li>
		...
		<%
					...
					int i=0;
				        ...
				        ResultSet rs=st.executeQuery("select count(proid) from producttable where procategory='Mobile' && procount>=1;");
				        String Countrow="";
				        while(rs.next()){
	...
	int q=0;
			...
			for(int o=0;o<m;o++){
				 ResultSet rs=st.executeQuery("select proid,proname,procategory,promodel,proprice,procount,discountprice,prooffr from producttable where procategory='Mobile' && procount>=1;");
			%>
		<div class="section">
			<!-- container -->
			<div class="container">
	      ...
	      <%   while(rs.next()){
	       ...
	       p++;
	        ...
	        %>
									...
									<button input type="button" class="add-to-cart-btn" onclick="img(<%=id%>)"><i class="fa fa-shopping-cart" ></i> add to cart</button>
